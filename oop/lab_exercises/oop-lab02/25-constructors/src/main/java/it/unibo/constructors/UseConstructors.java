...
class UseConstructors {
    ...
    public static void main(final String[] args) {
        ...
        final Student luigiGentile = new Student("Luigi", "Gentile", 1018, 2012);
        luigiGentile.printStudentInfo();

        final Student simoneBianchi = new Student("Simone", "Bianchi", 1019, 2010);
        simoneBianchi.printStudentInfo();

        final Student andreaBracci = new Student("Andrea", "Bracci", 1020, 2012);
        andreaBracci.printStudentInfo();

        final Train regional = new Train(300, 100, 200);
        regional.printTrainInfo();
        
        final Train frecciaRossa = new Train(1200, 150, 1050);
        frecciaRossa.printTrainInfo();
        
        final Train frecciaArgento = new Train(500, 0, 500);
