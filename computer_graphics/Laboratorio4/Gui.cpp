...
void my_interface()
{
    ...
    ImGui::SetNextWindowPos(ImVec2(50, 400)); // Imposta posizione finestra successiva (50, 1050)
    ...
    */
    ...
    ImGui::SliderInt("Righe", &numRows, 0, 20);
    ImGui::SliderInt("Colonne", &numCols, 0, 20);
