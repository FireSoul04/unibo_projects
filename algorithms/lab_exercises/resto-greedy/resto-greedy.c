...
void print_resto(int s[], int n, int R, int num_monete) {
    int i;
...
int is_val_used(int R, int moneta) {
    return R - moneta >= 0;
}
...
int resto(int R, int m[], int n, int s[])
{
    /* [TODO] */
    int i, k = 0;
